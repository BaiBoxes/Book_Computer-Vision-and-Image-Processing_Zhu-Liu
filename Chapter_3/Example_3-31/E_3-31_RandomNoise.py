...
------------------------
【例3-31】用numpy.random.randint函数与numpy.random.normal函数在图像中分别添加椒盐噪音和高斯噪音，并将原图与处理后的图显示出来。
------------------------
"""
...
if __name__ == '__main__':
    # 读取图像
    image = cv2.imread('image/Example-Bridge_gray.jpg', cv2.COLOR_BGR2RGB)
    # 添加椒盐噪音
    ...
    plt.axis('off')
    plt.subplot(132)
    plt.imshow(cv2.cvtColor(salt_and_pepper_noise_image, cv2.COLOR_BGR2RGB))
